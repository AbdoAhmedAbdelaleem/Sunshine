...
public class SunshineFakeDateByUdacity
{
    ...
    private static ContentValues createTestWeatherContentValues(long date) {
        ...
        testWeatherValues.put(SunshineContract.WeatherEntry.COLUMN_WEATHER_ID, weatherIDs[(int)(Math.random()*10)%5]);
    ...
    public static void insertFakeData(Context context) {
        ...
        for(int i=0; i<7; i++) {
            fakeValues.add(SunshineFakeDateByUdacity.createTestWeatherContentValues(today + TimeUnit.DAYS.toMillis(i)));
        }
